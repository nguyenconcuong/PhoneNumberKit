...
open class PhoneNumberTextField: UITextField, UITextFieldDelegate {
    ...
    private lazy var _defaultRegion: String = "VN"
    ...
    open func updateFlagWithRegion(region:String) {
    ...
    open func updatePlaceholderWithRegion(_ region:String) {
        ...
        let example = self.phoneNumberKit.getFormattedExampleNumber(forCountry: region, withFormat: format, withPrefix: self.withPrefix) ?? "12345678"
